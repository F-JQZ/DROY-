...
async def send_shop(ctx):
    embed = discord.Embed(title="🎁 بوسات", description="اضغط على زر ( عرض جميع التفاصيل )\n\nاضغط الزر بالأسفل لكامل التفاصيل", color=0xf1c40f)
...
# تأكد أن هذا السطر موجود في نهاية الكود
